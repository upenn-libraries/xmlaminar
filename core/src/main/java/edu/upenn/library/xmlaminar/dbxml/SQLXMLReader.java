...
import edu.upenn.library.xmlaminar.BoundedXMLFilterBuffer;
...
public abstract class SQLXMLReader extends VolatileXMLFilterImpl {
    ...
    private String sql;
    private static final Logger logger = LoggerFactory.getLogger(SQLXMLReader.class);
                    ...
                    if (expectedInputImplementation == InputImplementation.CHAR_ARRAY) {
                        if (readerContent != null) {
                            try {
                                ...
                                logger.error("error closing readerContent", ex);
                            }
                        }
                    }
                }
            ...
            for (int i = 0; i < outputFieldLabels.length; i++) {
                ...
                try {
                    ...
                    try {
                        ...
                        logger.error("error closing stream from database", ex);
                    }
                }
            }
        }
